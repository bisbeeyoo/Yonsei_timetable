...
st.markdown("""
    <style>
        ...
        * { font-family: 'Pretendard', sans-serif !important; }
        ...
        .sub-title { font-size: 1rem; color: #666; margin-bottom: 25px; }
        .card { background-color: #F8FAFC; padding: 20px; border-radius: 12px; border: 1px solid #E2E8F0; margin-bottom: 15px; }
...
def load_yonsei_data():
    raw_data = [
        # 교직일반, 논문, 교직이론 및 교직소양
        {"전공": "교직(공통)", "요일": "월", "교시": "1,2", "과목종별": "교직", "학정번호": "SPG6824-01", "과목명": "한국교육의 역사", "교수명": "이원재", "강의실": "교302", "학점": 3},
        {"전공": "교직(공통)", "요일": "화", "교시": "1,2", "과목종별": "교직", "학정번호": "SPG6858-01", "과목명": "교사의인식및실천연구(영어)", "교수명": "임웅", "강의실": "교304", "학점": 3},
        {"전공": "교직(공통)", "요일": "화", "교시": "1,2", "과목종별": "교직", "학정번호": "SPG6862-01", "과목명": "학습과학", "교수명": "이희승", "강의실": "교310", "학점": 3},
        {"전공": "교직(공통)", "요일": "목", "교시": "1,2", "과목종별": "교직", "학정번호": "SPG6867-01", "과목명": "교육자를위한인공지능입문", "교수명": "강근영", "강의실": "교302", "학점": 3},
        {"전공": "교직(공통)", "요일": "월", "교시": "3,4", "과목종별": "교직", "학정번호": "SPG6860-01", "과목명": "연세와교사의사명", "교수명": "곽호철", "강의실": "교603", "학점": 3},
        {"전공": "교직(공통)", "요일": "월", "교시": "3,4", "과목종별": "교직", "학정번호": "SPG6869-01", "과목명": "교육현장을위한문학읽기", "교수명": "곽수범", "강의실": "교601", "학점": 3},
        {"전공": "교직(공통)", "요일": "화", "교시": "3,4", "과목종별": "교직", "학정번호": "SPG6864-01", "과목명": "박물관교육", "교수명": "국성하", "강의실": "교405", "학점": 3},
        {"전공": "교직(공통)", "요일": "화", "교시": "3,4", "과목종별": "교직", "학정번호": "SPG6838-01", "과목명": "교육과일의세계", "교수명": "한수정", "강의실": "교302", "학점": 3},
        {"전공": "교직(공통)", "요일": "화", "교시": "3,4", "과목종별": "교직", "학정번호": "SPG6859-01", "과목명": "인공지능시대의과학기술과교육(영어)", "교수명": "임웅", "강의실": "교304", "학점": 3},
        {"전공": "교직(공통)", "요일": "화", "교시": "3,4", "과목종별": "교직", "학정번호": "SPG6853-01", "과목명": "학습동기", "교수명": "김은주", "강의실": "위204", "학점": 3},
        {"전공": "교직(공통)", "요일": "화", "교시": "3,4", "과목종별": "교직", "학정번호": "SPG6831-01", "과목명": "영재교육의이론과실제", "교수명": "윤성로", "강의실": "교306", "학점": 3},
        {"전공": "교직(공통)", "요일": "목", "교시": "3,4", "과목종별": "교직", "학정번호": "SPG6863-01", "과목명": "교사론", "교수명": "국성하", "강의실": "교404", "학점": 3},
        {"전공": "교직(공통)", "요일": "목", "교시": "3,4", "과목종별": "교직", "학정번호": "SPG6868-01", "과목명": "교육자를위한인공지능과코딩기초(영어)", "교수명": "한수연", "강의실": "교304", "학점": 3},
        
        # 교직이론 및 교직소양
        {"전공": "교직(자격증)", "요일": "월", "교시": "1,2", "과목종별": "교직", "학정번호": "SPT6662-01", "과목명": "교육철학및교육사", "교수명": "황금중", "강의실": "교404", "학점": 2},
        {"전공": "교직(자격증)", "요일": "월", "교시": "1,2", "과목종별": "교직", "학정번호": "SPT6644-01", "과목명": "교육사회학", "교수명": "김영미", "강의실": "교306", "학점": 2},
        {"전공": "교직(자격증)", "요일": "월", "교시": "1,2", "과목종별": "교직", "학정번호": "SPT6668-01", "과목명": "교직실무", "교수명": "심연식", "강의실": "교303", "학점": 2},
        {"전공": "교직(자격증)", "요일": "월", "교시": "1,2", "과목종별": "교직", "학정번호": "SPT6661-01", "과목명": "교육행정및교육경영", "교수명": "유동훈", "강의실": "교308", "학점": 2},
        {"전공": "교직(자격증)", "요일": "화", "교시": "1,2", "과목종별": "교직", "학정번호": "SPT6643-02", "과목명": "교육심리학", "교수명": "원영실", "강의실": "교410", "학점": 2},
        {"전공": "교직(자격증)", "요일": "화", "교시": "1,2", "과목종별": "교직", "학정번호": "SPT6663-02", "과목명": "교육방법및교육공학", "교수명": "김은주", "강의실": "교405", "학점": 2},
        {"전공": "교직(자격증)", "요일": "목", "교시": "1,2", "과목종별": "교직", "학정번호": "SPT6667-02", "과목명": "특수교육학개론", "교수명": "김지영", "강의실": "교303", "학점": 2},
        {"전공": "교직(자격증)", "요일": "월", "교시": "3,4", "과목종별": "교직", "학정번호": "SPT6662-02", "과목명": "교육철학및교육사", "교수명": "국성하", "강의실": "교404", "학점": 2},
        {"전공": "교직(자격증)", "요일": "화", "교시": "3,4", "과목종별": "교직", "학정번호": "SPT6643-03", "과목명": "교육심리학", "교수명": "원영실", "강의실": "교410", "학점": 2},
        {"전공": "교직(자격증)", "요일": "목", "교시": "3,4", "과목종별": "교직", "학정번호": "SPT6667-03", "과목명": "특수교육학개론", "교수명": "김지영", "강의실": "교303", "학점": 2},
        
        # 평생교육사
        {"전공": "평생교육사", "요일": "수", "교시": "1,2", "과목종별": "교직", "학정번호": "SPL6691", "과목명": "평생교육프로그램개발론", "교수명": "최유연", "강의실": "교402", "학점": 3},
        {"전공": "평생교육사", "요일": "수", "교시": "1,2", "과목종별": "교직", "학정번호": "SPL6650", "과목명": "평생교육론", "교수명": "이상오", "강의실": "교404", "학점": 3},
        {"전공": "평생교육사", "요일": "금", "교시": "1,2", "과목종별": "교직", "학정번호": "SPL6692", "과목명": "평생교육실습", "교수명": "한수정", "강의실": "교404", "학점": 3},

        # 교육공학
        {"전공": "교육공학", "요일": "월", "교시": "1,2", "과목종별": "전공", "학정번호": "SET6602-01", "과목명": "교수학습이론", "교수명": "이명근", "강의실": "교606", "학점": 3},
        {"전공": "교육공학", "요일": "화", "교시": "1,2", "과목종별": "전공", "학정번호": "SET6608-01", "과목명": "AI교육공학기초", "교수명": "김남주", "강의실": "교606", "학점": 3},
        {"전공": "교육공학", "요일": "목", "교시": "1,2", "과목종별": "선택", "학정번호": "SET6652-01", "과목명": "원격교육론", "교수명": "이지영", "강의실": "교606", "학점": 3},

        # 조기영어교육
        {"전공": "조기영어교육", "요일": "월", "교시": "1,2", "과목종별": "선택", "학정번호": "SEC6711-01", "과목명": "조기영어교육과통계학", "교수명": "이민진", "강의실": "백S404", "학점": 3},
        {"전공": "조기영어교육", "요일": "화", "교시": "1,2", "과목종별": "전공", "학정번호": "SEC6701-01", "과목명": "조기영어교육연구방법론", "교수명": "이희경", "강의실": "교517", "학점": 3},
        {"전공": "조기영어교육", "요일": "목", "교시": "1,2", "과목종별": "전공", "학정번호": "SEC6606-01", "과목명": "영어학개론", "교수명": "김현우", "강의실": "백S204", "학점": 3},

        # AI융합교육
        {"전공": "AI융합교육", "요일": "월", "교시": "1,2", "과목종별": "선택", "학정번호": "SAE6521-01", "과목명": "빅데이터와교육", "교수명": "한수연", "강의실": "교517", "학점": 3},
        {"전공": "AI융합교육", "요일": "화", "교시": "1,2", "과목종별": "선택", "학정번호": "SAE6527-01", "과목명": "AI활용융합교육방법", "교수명": "한수연", "강의실": "교603", "학점": 3}
    ]
...
# --- [수정] st.query_params 최신 문법으로 안전하게 동기화 ---
...
if "courses" in query_dict and not st.session_state.my_courses:
    try:
        ...
        # [수정] ⚠️ 기존 .clear() 지우고 최신 딕셔너리 조작 방식으로 경고 해결
...
if not st.session_state.my_courses:
    st.info("💡 왼쪽 사이드바 패널에서 과목을 선택해 추가하면 실시간으로 시간표 보드가 완성됩니다!")
else:
    ...
    with col_b:
        if st.button("🗑️ 전체 초기화", use_container_width=True):
            ...
            # [수정] ⚠️ 전체 초기화 시에도 안전하게 query_params 제거 루프문 활용
            for key in list(st.query_params.keys()):
                del st.query_params[key]
            st.rerun()

    # 인스타 감성 낭낭한 미니멀 시간표 생성
    days = ['월', '화', '수', '목', '금']
    periods = [1, 2, 3, 4]
    ...
    <button id="download-btn" style="width:100%; margin-top:15px; padding:12px; background-color:#112F6F; color:white; border:none; border-radius:10px; cursor:pointer; font-weight:600; font-size:14px;">✨ 인스타 감성 시간표 이미지 저장하기</button>
